...
const FooterPages = () => {
    return (
        <footer className="p-2 bg-dark text-white text-center position-relative">
            <Link to="/fr" className="position-absolute top-10 start-0 pt-4">
            ...
            <div className="container pt-3">	
                <div className="d-md-flex flex-row align-items-center justify-content-center">				
                    ...
                    <div className="p-md-4 p-sm-3"><Link to="/activites" className="decoration">Domaines d'activité</Link></div>
                    <div className="p-md-4 p-sm-3"><Link to="/contribuer" className="decoration">Comment contribuer</Link></div>
