        ...
        <footer className="p-2 bg-dark text-white text-center position-relative">
            ...
            <div className="container pt-3">	
                <div className="d-md-flex flex-row align-items-center justify-content-center">				
                    <div className="p-md-4 p-sm-3"><a href="#quemsomos" className="decoration">Qui sommes-nous</a></div>
                    <div className="p-md-4 p-sm-3"><a href="#iniciativas" className="decoration">Domaines d'activité</a></div>
                    <div className="p-md-4 p-sm-3"><a href="#colaborar" className="decoration">Comment contribuer</a></div>
                    <div className="p-md-4 p-sm-3"><a href="#blog" className="decoration">Blog</a></div>
                    <div className="p-md-4 p-sm-3"><a href="#contactos" className="decoration">Nous contacter</a></div>
                </div>	
                <p>Copyright &copy; 2021 Clóçon Pôvô - Diaspora Santoméenne</p>
                <Link to="/fr" className="position-absolute bottom-0 end-0 p-5">
