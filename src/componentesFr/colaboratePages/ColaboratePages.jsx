        ...
        <section  className="p-5 text-light text-center text-sm-start">
            <div className="container">		
                <div className="d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h2 className="text-dark">Comment contribuer?</h2>
                        ...
                        <h5 className="mt-4 text-warning">Collecte de fonds</h5>
                        <p className="text-dark">
                        ...
                        <h5 className="mt-4 text-warning">Le bénévolat</h5>
                        <p className="text-dark">
                        ...
                        <a 
                            ...
                            rel="noreferrer"
                        >
                            Accédez au lien du ministère de l'Économie pour plus d'informations
                        </a>
                    </div>
